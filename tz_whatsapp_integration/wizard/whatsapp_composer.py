...
class WhatsAppComposer(models.TransientModel):
        ...
        if context.get('active_model'):
            ...
            if wa_template_id and not result.get('wa_template_id'):
                ...
                if self.env.user.has_group('base.group_erp_manager'):
                    action = self.env.ref('tz_whatsapp_integration.whatsapp_template_action')
    ...
    def _compute_preview_whatsapp(self):
        ...
        for record in self:
            ...
            if record.wa_template_id and rec:
                record.preview_whatsapp = self.env['ir.qweb']._render('tz_whatsapp_integration.template_message_preview', {
    ...
    def _send_whatsapp_template(self):
        ...
        for rec in records:
            ...
            if '+' not in mobile_number:mobile_number = '+'+mobile_number
            ...
            return self.env['whatsapp'].send_template_message(body,rec,self.wa_template_id,free_text_json)
